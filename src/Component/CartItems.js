...
export default function () {
  ...
  return (
    <div className=" container-sm d-flex flex-column flex-lg-row mt-4 gap-3">
      ...
      <PriceDetail className=" bg-white p-5 d-flex flex-column gap-2 " style={{backgroundColor:"#E9EEF6", boxShadow: "0px 3px 50px #A5A5A5"}}>
        <span className="fs-5  pb-2 fw-bold text-center" style={{color:"#047BD5" }}>Price Details</span>
